      ...
      <div className="container relative mx-auto px-6">
        ...
        >
          <div className="mb-6 inline-flex items-center rounded-full border border-border bg-card px-4 py-1.5 text-sm font-medium text-muted-foreground">
            ...
            AI-powered email safety
          </div>
          <h1 className="font-heading text-4xl font-bold leading-tight tracking-tight text-foreground md:text-6xl">
            AI outbound emails —{" "}
            <span className="text-primary">reviewed before they're sent</span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground md:text-xl">
            DraftGuard generates personalized emails with AI and runs an intelligent review to catch hallucinations, tone issues, and risky claims before anything goes out.
          </p>
        ...
        >
          <div className="overflow-hidden rounded-xl border border-border bg-card shadow-2xl shadow-primary/5">
            <div className="flex items-center gap-2 border-b border-border px-4 py-3">
              ...
              <span className="ml-2 text-xs text-muted-foreground">DraftGuard — Approval Queue</span>
            </div>
            <div className="grid gap-0 md:grid-cols-2">
              {/* Email preview */}
              <div className="border-b border-border p-6 md:border-b-0 md:border-r">
                <div className="mb-4 text-xs font-medium uppercase tracking-wider text-muted-foreground">Email Preview</div>
              ...
              <div className="p-6">
                ...
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <span className="text-sm text-muted-foreground">Confidence: <strong className="text-foreground">94/100</strong></span>
                </div>
                <div className="space-y-2">
                  <div className="flex items-start gap-2 rounded-lg bg-accent/50 p-3">
                    ...
                    <span className="text-xs text-muted-foreground">No hallucinated claims detected</span>
                  </div>
                  <div className="flex items-start gap-2 rounded-lg bg-accent/50 p-3">
                    <span className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-success" />
                    <span className="text-xs text-muted-foreground">Personalization verified</span>
                  </div>
                  <div className="flex items-start gap-2 rounded-lg bg-accent/50 p-3">
                    <span className="mt-0.5 h-1.5 w-1.5 shrink-0 rounded-full bg-success" />
                    <span className="text-xs text-muted-foreground">Tone: Professional ✓</span>
                  </div>
                </div>
              </div>
            </div>
